...
DATA_DEFAULT_PATH=r"C:\Users\nithy\CIPProject\Social_media_Prediction_depression\Scripts\Images_functions\Pexels\Happy\pexels-downloader\results_pexels"
...
def load_data(data_path=DATA_DEFAULT_PATH, seed=DEFAULT_SEED, test_size=DEFAULT_TEST_SIZE):
    ...
    P = np.load(r"C:\Users\nithy\CIP Project\Social_media_Prediction_depression\Scripts\Images_functions\Pexels\Happy\pexels-downloader\results_pexels\positivedata.npz", allow_pickle=True)  # load data for depressed users
    N = np.load(r"C:\Users\nithy\CIP Project\Social_media_Prediction_depression\Scripts\Images_functions\Pexels\Happy\pexels-downloader\results_pexels\negativedata.npz", allow_pickle=True)  # load data for not depressed users
